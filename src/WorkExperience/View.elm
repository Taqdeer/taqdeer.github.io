        ...
        [ row [ alignLeft, width fill ]
            [ column [ alignLeft, spacing 10, width fill ]
                ...
                , column [ alignLeft, width fill, spacingXY 0 20 ]
                    [ paragraph [ width fill, Font.alignLeft, Font.size 15 ] [ text " Developed the front end single page application from scratch which is live at https://www.withflint.com. The complete website has been written in Elm." ]
                    ...
                    , paragraph [ width fill, Font.alignLeft, Font.size 15 ] [ text " One of the biggest challenges which I faced was that I had no experience in functional programming. Still, I learnt Elm within a span of three weeks which in turn got identified as an imperative asset by the software team at Flint. " ]
                    ]
                ]
            ]
        , row [ alignLeft, width fill ]
