...
{
	if (region.aT.ad === region.a4.ad)
	{
		return 'on line ' + region.aT.ad;
	}
	return 'on lines ' + region.aT.ad + ' through ' + region.a4.ad;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cC: 'hidden', cg: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cC: 'mozHidden', cg: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cC: 'msHidden', cg: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cC: 'webkitHidden', cg: 'webkitvisibilitychange' }
		: { cC: 'hidden', cg: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cP, request.dK, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.dK));
		}
...
var $author$project$Types$MsgForRouter = function (a) {
	return {$: 0, a: a};
};
var $author$project$Router$Types$OnUrlChange = function (a) {
	return {$: 0, a: a};
};
var $author$project$Router$Types$OnUrlRequest = function (a) {
	return {$: 1, a: a};
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a6: fragment, bc: host, bo: path, bq: port_, bt: protocol, bu: query};
	});
...
var $author$project$Types$Model = F3(
	function (router, cats, counter) {
		return {cf: cats, cm: counter, c4: router};
	});
var $author$project$Types$MsgForCats = function (a) {
	return {$: 1, a: a};
};
var $author$project$Types$MsgForCounter = function (a) {
	return {$: 2, a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $Fresheyeball$elm_return$Return$andMap = F2(
	function (_v0, _v1) {
		var model = _v0.a;
		var cmd_ = _v0.b;
		var f = _v1.a;
...
var $author$project$Update$andMapCmd = function (msg) {
	return A2(
		$elm$core$Basics$composeL,
		$Fresheyeball$elm_return$Return$andMap,
		$Fresheyeball$elm_return$Return$mapCmd(msg));
};
var $krisajenkins$remotedata$RemoteData$NotAsked = {$: 0};
var $author$project$Cats$Types$NewGif = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Cats$Data$decodeGifUrl = A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b_: false, b6: r.b6, cs: r.cs, a9: r.a9, cP: r.cP, dD: r.dD, bH: r.bH, dK: r.dK}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b6: $elm$http$Http$emptyBody, cs: r.cs, a9: _List_Nil, cP: 'GET', dD: $elm$core$Maybe$Nothing, bH: $elm$core$Maybe$Nothing, dK: r.dK});
};
var $author$project$Cats$Data$getRandomGif = function (topic) {
	var url = 'https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=' + topic;
	var returnMsg = A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Cats$Types$NewGif);
	return $elm$http$Http$get(
		{
			cs: A2($elm$http$Http$expectJson, returnMsg, $author$project$Cats$Data$decodeGifUrl),
			dK: url
		});
};
...
var $author$project$Cats$Update$init = A2(
	$Fresheyeball$elm_return$Return$return,
	{cA: $krisajenkins$remotedata$RemoteData$NotAsked, dH: 'cats'},
	$author$project$Cats$Data$getRandomGif('cats'));
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Counter$Update$init = A2($Fresheyeball$elm_return$Return$return, 0, $elm$core$Platform$Cmd$none);
var $author$project$Router$Routes$NotFound = 1;
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {K: frag, P: params, G: unvisited, y: value, R: visited};
	});
...
var $author$project$Router$Routes$CatsPage = 2;
var $author$project$Router$Routes$CounterPage = 3;
var $author$project$Router$Routes$Home = 0;
...
var $author$project$Router$Routes$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
...
var $author$project$Router$Update$init = F2(
	function (url, key) {
		return A2(
			$Fresheyeball$elm_return$Return$return,
			{
				...
				c_: A2(
					...
					1,
					A2($elm$url$Url$Parser$parse, $author$project$Router$Routes$routes, url))
			},
...
var $author$project$Update$init = F3(
	function (_v0, url, key) {
		return A3(
			$author$project$Update$andMapCmd,
			$author$project$Types$MsgForCounter,
			$author$project$Counter$Update$init,
			A3(
				$author$project$Update$andMapCmd,
				$author$project$Types$MsgForCats,
				$author$project$Cats$Update$init,
				A3(
					$author$project$Update$andMapCmd,
					$author$project$Types$MsgForRouter,
					A2($author$project$Router$Update$init, url, key),
					$Fresheyeball$elm_return$Return$singleton($author$project$Types$Model))));
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $krisajenkins$remotedata$RemoteData$Loading = {$: 1};
var $author$project$Cats$Update$updateCats = F2(
	function (msg, model) {
		if (!msg.$) {
			return A2(
				$Fresheyeball$elm_return$Return$return,
				_Utils_update(
					model,
					{cA: $krisajenkins$remotedata$RemoteData$Loading}),
				$author$project$Cats$Data$getRandomGif(model.dH));
		} else {
			var result = msg.a;
			return A2(
				$Fresheyeball$elm_return$Return$return,
...
var $author$project$Cats$Update$update = F2(
	function (msgFor, model) {
		if (msgFor.$ === 1) {
			var msg = msgFor.a;
			return A2($author$project$Cats$Update$updateCats, msg, model);
		} else {
			return A2($Fresheyeball$elm_return$Return$return, model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Counter$Update$updateCounter = F2(
	function (msg, model) {
		if (!msg) {
			return A2($Fresheyeball$elm_return$Return$return, model + 1, $elm$core$Platform$Cmd$none);
		} else {
			return A2($Fresheyeball$elm_return$Return$return, model - 1, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Counter$Update$update = F2(
	function (msgFor, model) {
		if (msgFor.$ === 2) {
			var msg = msgFor.a;
			return A2($author$project$Counter$Update$updateCounter, msg, model);
		} else {
			return A2($Fresheyeball$elm_return$Return$return, model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Router$Routes$toPath = function (page) {
	switch (page) {
		case 0:
			return '/';
		case 1:
...
var $author$project$Router$Update$updateRouter = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var url = msg.a;
			...
			default:
				...
				return A2(
					...
					A2(
						$elm$browser$Browser$Navigation$pushUrl,
						model.cM,
						$author$project$Router$Routes$toPath(page)));
		}
	});
var $author$project$Router$Update$update = F2(
	function (msgFor, model) {
		if (!msgFor.$) {
			var msg = msgFor.a;
			return A2($author$project$Router$Update$updateRouter, msg, model);
		} else {
			return A2($Fresheyeball$elm_return$Return$return, model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Update$update = F2(
	function (msg, model) {
		return A3(
			$author$project$Update$andMapCmd,
			$author$project$Types$MsgForCounter,
			A2($author$project$Counter$Update$update, msg, model.cm),
			A3(
				$author$project$Update$andMapCmd,
				$author$project$Types$MsgForCats,
				A2($author$project$Cats$Update$update, msg, model.cf),
				A3(
					$author$project$Update$andMapCmd,
					$author$project$Types$MsgForRouter,
					A2($author$project$Router$Update$update, msg, model.c4),
					$Fresheyeball$elm_return$Return$singleton($author$project$Types$Model))));
	});
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bP: 'a', aE: 'atv', bS: 'ab', bT: 'cx', bU: 'cy', bV: 'acb', bW: 'accx', bX: 'accy', bY: 'acr', aZ: 'al', a_: 'ar', bZ: 'at', aF: 'ah', aG: 'av', b0: 's', b4: 'bh', b5: 'b', b7: 'w7', b9: 'bd', ca: 'bdt', al: 'bn', cb: 'bs', am: 'cpe', ch: 'cp', ci: 'cpx', cj: 'cpy', A: 'c', ao: 'ctr', ap: 'cb', aq: 'ccx', B: 'ccy', ac: 'cl', ar: 'cr', cl: 'ct', cn: 'cptr', co: 'ctxt', cx: 'fcs', cy: 'fs', cB: 'g', aK: 'hbh', au: 'hc', aL: 'hf', bb: 'hfp', cD: 'hv', cF: 'ic', cH: 'fr', cJ: 'iml', cK: 'it', cL: 'i', W: 'nb', bj: 'notxt', cT: 'ol', cV: 'or', O: 'oq', cZ: 'oh', c_: 'pg', bn: 'p', c$: 'ppe', c3: 'ui', s: 'r', c6: 'sb', c7: 'sbx', c8: 'sby', c9: 'sbt', dc: 'e', dd: 'cap', de: 'sev', dm: 'sk', q: 't', dp: 'tc', dq: 'w8', dr: 'w2', ds: 'w9', dt: 'tj', aB: 'tja', du: 'tl', dv: 'w3', dw: 'w5', dx: 'w4', dy: 'tr', dz: 'w6', dA: 'w1', dB: 'tun', bI: 'ts', Q: 'clr', dI: 'u', aV: 'wc', bM: 'we', aW: 'wf', bN: 'wfp', aX: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cB);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c_);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bn);
...
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dc);
...
var $mdgriffith$elm_ui$Internal$Flag$alignLeft = $mdgriffith$elm_ui$Internal$Flag$flag(40);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.c5)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.u)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.df.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.df.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.s) + ('-' + ($elm$core$String$fromInt(pos.ck) + ('-' + ($elm$core$String$fromInt(pos.aa) + ('-' + $elm$core$String$fromInt(pos.V)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.bD) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b0) + (':focus .focusable, ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b0) + '.focusable:focus')),
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cD, $mdgriffith$elm_ui$Internal$Style$classes.Q)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cD, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cx, $mdgriffith$elm_ui$Internal$Style$classes.Q)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cx, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {an: closing, h: _List_Nil, F: _List_Nil, x: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.x + ('{' + (renderValues(rule.F) + (rule.an + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.dd, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.dd))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.q + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.q)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {V: height / size, bD: size, bK: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ce, adjustment.b3, adjustment.cp, adjustment.cO]);
	var lineHeight = 1.5;
	...
	return {
		...
		a7: A3($mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.V)),
				_Utils_Tuple2(
				'vertical-align',
					...
					switch (pseudo) {
						...
						case 0:
							...
							return A2(
								...
								'\n',
								_List_fromArray(
									[selector + ('-fs:focus {' + (renderedProps + '\n}')), '.' + ($mdgriffith$elm_ui$Internal$Style$classes.b0 + (':focus ~ ' + (selector + ('-fs:not(.focus)  {' + (renderedProps + '\n}'))))), '.' + ($mdgriffith$elm_ui$Internal$Style$classes.b0 + (':focus ' + (selector + ('-fs  {' + (renderedProps + '\n}'))))), '.focusable-parent:focus ~ ' + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + (selector + ('-fs {' + (renderedProps + '\n}'))))))]));
						default:
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var left = '.' + $mdgriffith$elm_ui$Internal$Style$classes.aZ;
					...
					case 8:
						...
						var rows = function (x) {
							...
							A2(
								$elm$core$String$join,
								' ',
								A2($elm$core$List$map, toGridLength, template.c5)));
					...
					case 9:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									...
									'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.V) + ';'),
									'-ms-grid-column: ' + ($elm$core$String$fromInt(position.ck) + ';'),
									'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.aa) + ';')
								]));
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + ($elm$core$String$fromInt(position.s) + (' / ' + ($elm$core$String$fromInt(position.s + position.V) + ';'))),
									'grid-column: ' + ($elm$core$String$fromInt(position.ck) + (' / ' + ($elm$core$String$fromInt(position.ck + position.aa) + ';')))
								]));
						var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.s) + ('-' + ($elm$core$String$fromInt(position.ck) + ('-' + ($elm$core$String$fromInt(position.aa) + ('-' + $elm$core$String$fromInt(position.V)))))));
...
var $mdgriffith$elm_ui$Internal$Model$finalizeNode = F6(
	function (has, node, attributes, children, embedMode, parentContext) {
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dc))
									]))
							]));
			}
		}();
		switch (parentContext) {
			case 0:
				return (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$widthFill, has) && (!A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$widthBetween, has))) ? html : (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$alignLeft, has) ? A2(
					$elm$html$Html$u,
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.B, $mdgriffith$elm_ui$Internal$Style$classes.bY])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.B, $mdgriffith$elm_ui$Internal$Style$classes.bW])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.bX])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.bV])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.q, $mdgriffith$elm_ui$Internal$Style$classes.aV, $mdgriffith$elm_ui$Internal$Style$classes.au])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.q, $mdgriffith$elm_ui$Internal$Style$classes.aW, $mdgriffith$elm_ui$Internal$Style$classes.aL])))
			]),
		_List_fromArray(
			[
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.cE, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.bP]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.b5]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.cV]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.cT]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.cH]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.b4]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.cE, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aZ);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a_);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bT);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bZ);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bS);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bU);
	}
};
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.bM + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.bN + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.bM + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bN + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$xAlign, has)) {
							...
							var $temp$classes = $mdgriffith$elm_ui$Internal$Model$alignXName(x) + (' ' + classes),
								...
								switch (x) {
									...
									case 2:
										return A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$alignLeft, flags);
									default:
										return flags;
								}
							}(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								cD: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
				...
				default:
					...
					if (_v6.$ === 1) {
						return _Utils_update(
							record,
							{
								cR: $elm$core$Maybe$Just(renderMode)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cx: $elm$core$Maybe$Nothing, cD: $elm$core$Maybe$Nothing, cR: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.dc]))),
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ac)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.B)),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $author$project$Styles$title = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$color(
		A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0)),
		$mdgriffith$elm_ui$Element$Font$size(40)
	]);
var $author$project$Cats$Types$MorePlease = {$: 0};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aq + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.B + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.c9 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bj)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$image = F2(
	function (attrs, _v0) {
		...
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cF),
				attrs),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[
...
var $author$project$Cats$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					$author$project$Styles$title),
				$mdgriffith$elm_ui$Element$text(model.dH)),
				A2(
				...
				{
					cN: $mdgriffith$elm_ui$Element$text('More Please!'),
					cU: $elm$core$Maybe$Just($author$project$Cats$Types$MorePlease)
				}),
				function () {
				var _v0 = model.cA;
				switch (_v0.$) {
					...
					case 3:
						...
						return A2(
							...
							_List_Nil,
							{cq: 'a random ' + (model.dH + ' gif'), dh: gifUrl});
					default:
						return $mdgriffith$elm_ui$Element$text('Error loading gif');
				}
			}()
			]));
};
var $author$project$Counter$Types$Decrement = 1;
var $author$project$Counter$Types$Increment = 0;
var $mdgriffith$elm_ui$Internal$Model$AlignY = function (a) {
	return {$: 5, a: a};
};
var $mdgriffith$elm_ui$Internal$Model$CenterY = 1;
var $mdgriffith$elm_ui$Element$centerY = $mdgriffith$elm_ui$Internal$Model$AlignY(1);
var $author$project$Counter$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					$author$project$Styles$button),
				{
					cN: $mdgriffith$elm_ui$Element$text('-'),
					cU: $elm$core$Maybe$Just(1)
				}),
...
var $author$project$View$renderRoute = function (model) {
	var _v0 = model.c4.c_;
	switch (_v0) {
		case 0:
			return A2(
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									...
									$author$project$Styles$button),
								{
									cN: $mdgriffith$elm_ui$Element$text('Go to Cats'),
									dK: $author$project$Router$Routes$toPath(2)
								}),
								A2(
								$mdgriffith$elm_ui$Element$link,
								_Utils_ap(
									...
									$author$project$Styles$button),
								{
									cN: $mdgriffith$elm_ui$Element$text('Go to Counter'),
									dK: $author$project$Router$Routes$toPath(3)
								})
							]))
					]));
		case 1:
		...
		case 2:
			return A2(
				...
				$author$project$Types$MsgForCats,
				$author$project$Cats$View$view(model.cf));
		default:
			return A2(
				$mdgriffith$elm_ui$Element$map,
				$author$project$Types$MsgForCounter,
				$author$project$Counter$View$view(model.cm));
	}
};
		...
		b6: _List_fromArray(
			[
				...
				A2(
					...
					$author$project$View$renderRoute(model)))
			]),
		dE: 'Taqdeer'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		cI: $author$project$Update$init,
		cW: A2($elm$core$Basics$composeL, $author$project$Types$MsgForRouter, $author$project$Router$Types$OnUrlChange),
		cX: A2($elm$core$Basics$composeL, $author$project$Types$MsgForRouter, $author$project$Router$Types$OnUrlRequest),
		$7: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		dJ: $author$project$Update$update,
		dL: $author$project$View$view
	});
